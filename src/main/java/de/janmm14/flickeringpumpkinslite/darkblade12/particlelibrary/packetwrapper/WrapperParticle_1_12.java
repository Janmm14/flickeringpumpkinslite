 ...
 */
package de.janmm14.flickeringpumpkinslite.darkblade12.particlelibrary.packetwrapper;
...
public class WrapperParticle_1_12 extends AbstractPacket {
	public static final PacketType TYPE =
			PacketType.Play.Server.WORLD_PARTICLES;

	public WrapperParticle_1_12() {
		super(new PacketContainer(TYPE), TYPE);
		handle.getModifier().writeDefaults();
	}

	public WrapperParticle_1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
